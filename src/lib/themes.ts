...
export const PALETTES: Palette[] = [
  ...
  {
    id: 'neon', name: 'Neón',
    swatches: ['#FF00AA', '#00FFAA', '#CC00FF'],
    light: {
      '--salmon': '#FF0080', '--salmon-bg': 'rgba(255,0,128,0.12)',
      '--mint': '#00CC44', '--mint-bg': 'rgba(0,204,68,0.12)',
      '--lavender': '#9900FF', '--lavender-bg': 'rgba(153,0,255,0.12)',
      '--sky': '#0099FF', '--sky-bg': 'rgba(0,153,255,0.12)',
      '--protein': '#9900FF', '--carbs': '#DD9900', '--carbs-bg': 'rgba(221,153,0,0.12)',
      '--fat': '#FF0080', '--fat-bg': 'rgba(255,0,128,0.12)',
      '--warning': '#DD9900', '--danger': '#FF0040', '--success': '#00CC44',
      '--bg': '#FFFFFF', '--bg-card': '#F8F0FF', '--bg-input': '#EEE0FF',
      '--border': '#DDCCFF', '--text': '#0A0020', '--text-muted': '#6600BB',
      '--grad-start': '#FF0080', '--grad-end': '#9900FF',
      '--banner-start': '#FFE0F4', '--banner-end': '#F0D8FF',
    },
    dark: {
      '--salmon': '#FF00AA', '--salmon-bg': 'rgba(255,0,170,0.18)',
      '--mint': '#00FF88', '--mint-bg': 'rgba(0,255,136,0.15)',
      '--lavender': '#CC00FF', '--lavender-bg': 'rgba(204,0,255,0.18)',
      '--sky': '#00FFFF', '--sky-bg': 'rgba(0,255,255,0.14)',
      '--protein': '#CC00FF', '--carbs': '#FFFF00', '--carbs-bg': 'rgba(255,255,0,0.14)',
      '--fat': '#FF00AA', '--fat-bg': 'rgba(255,0,170,0.18)',
      '--warning': '#FFCC00', '--danger': '#FF0040', '--success': '#00FF88',
      '--bg': '#000000', '--bg-card': '#0A000F', '--bg-input': '#150020',
      '--border': '#330044', '--text': '#FFFFFF', '--text-muted': '#CC88FF',
      '--grad-start': '#FF00AA', '--grad-end': '#00FFFF',
      '--banner-start': 'rgba(255,0,170,0.18)', '--banner-end': 'rgba(0,255,255,0.12)',
    },
  },
];
